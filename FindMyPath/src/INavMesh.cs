...
namespace fmp
{
    ...
    public interface INavMesh
    {
        ...
        double ComputeDistanceToGoal(ulong goalIndex, ulong nodeIndex);
        ...
        /// <returns></returns>
        double ComputeCostToNeighbor(ulong neighborIndex, ulong nodeIndex);
        ...
        /// <param name="nodeIndex"></param>
        /// <returns></returns>
        List<ulong> GetNeighbors(ulong nodeIndex);
